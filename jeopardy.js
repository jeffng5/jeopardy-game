...
obj2.addEventListener('click', function(e){e.preventDefault(); obj2.innerHTML = cat3q1q1.q})
...
obj5.addEventListener('click', function(e){e.preventDefault(); obj5.innerHTML = cat2q1.q})
...
obj6.addEventListener('dblclick', function(e){e.preventDefault(); obj6.innerHTML = "" ;obj6.innerHTML=cat2q2.a})
let obj7 = $('.questions2 td').get(1)
obj7.addEventListener('click', function(e){e.preventDefault(); obj7.innerHTML = cat2q2.q})
obj7.addEventListener('dblclick', function(e){e.preventDefault(); obj7.innerHTML = "" ;obj7.innerHTML=cat3q2.a})
let obj8 = $('.questions2 td').get(2)
obj8.addEventListener('click', function(e){e.preventDefault(); obj5.innerHTML = cat3q2.q})
obj8.addEventListener('dblclick', function(e){e.preventDefault(); obj5.innerHTML = "" ;obj8.innerHTML=cat3q2.a})
...
obj13.addEventListener('click', function(e){e.preventDefault(); obj13.innerHTML = cat1q3.q})
...
obj14.addEventListener('click', function(e){e.preventDefault(); obj14.innerHTML = cat1q3.q})
obj14.addEventListener('dblclick', function(e){e.preventDefault(); obj14.innerHTML = "" ;obj14.innerHTML=cat3q3.a})
let obj15 = $('.questions3 td').get(0)
obj15.addEventListener('click', function(e){e.preventDefault(); obj15.innerHTML = cat1q3.q})
obj15.addEventListener('dblclick', function(e){e.preventDefault(); obj15.innerHTML = "" ;obj15.innerHTML=cat4q3.a})
let obj16 = $('.questions3 td').get(0)
obj16.addEventListener('click', function(e){e.preventDefault(); obj16.innerHTML = cat1q3.q})
obj16.addEventListener('dblclick', function(e){e.preventDefault(); obj16.innerHTML = "" ;obj16.innerHTML=cat5q3.a})
let obj17 = $('.questions3 td').get(0)
obj17.addEventListener('click', function(e){e.preventDefault(); obj17.innerHTML = cat1q3.q})
...
obj18.addEventListener('dblclick', function(e){e.preventDefault(); obj18.innerHTML = "" ;obj18.innerHTML=cat6q3.a})
let obj19 = $('.questions4 td').get(1)
obj19.addEventListener('click', function(e){e.preventDefault(); obj19.innerHTML = cat2q4.q})
obj19.addEventListener('dblclick', function(e){e.preventDefault(); obj19.innerHTML = "" ;obj19.innerHTML=cat6q3.a})
let obj20 = $('.questions4 td').get(2)
obj20.addEventListener('click', function(e){e.preventDefault(); obj20.innerHTML = cat3q4.q})
obj20.addEventListener('dblclick', function(e){e.preventDefault(); obj20.innerHTML = "" ;obj20.innerHTML=cat6q3.a})
let obj21 = $('.questions4 td').get(3)
obj21.addEventListener('click', function(e){e.preventDefault(); obj21.innerHTML = cat4q4.q})
obj21.addEventListener('dblclick', function(e){e.preventDefault(); obj21.innerHTML = "" ;obj21.innerHTML=cat6q3.a})
let obj22 = $('.questions4 td').get(4)
obj22.addEventListener('click', function(e){e.preventDefault(); obj22.innerHTML = cat5q4.q})
obj22.addEventListener('dblclick', function(e){e.preventDefault(); obj22.innerHTML = "" ;obj22.innerHTML=cat6q3.a})
let obj23 = $('.questions4 td').get(5)
obj23.addEventListener('click', function(e){e.preventDefault(); obj23.innerHTML = cat6q4.q})
obj23.addEventListener('dblclick', function(e){e.preventDefault(); obj23.innerHTML = "" ;obj23.innerHTML=cat6q3.a})
